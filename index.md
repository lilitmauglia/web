<html>
    ...
    <body>
        ...
        <img width="500" src="pyramide.webp"/>

        <img width="600" src="tisch1.webp"/>

        <h1>Lieder</h1>
        <p>Ich teile mit Euch meine allerliebsten Weihnachtslieder.</p>
        ...
        <h1>Essen</h1>
        <p>Ich teile mit Euch meine allerliebsten Speisen.</p>
        <img width="400" src="https://www.einfachmalene.de/wp-content/uploads/2019/11/Weiche-Lebkuchen-18.jpg"/>

        <img width="400" src="https://www.lebkuchenherz.de/cdn/shop/files/1350-Lebkuchenmaenner.webp?v=1729580492&width=713"/>
        ...
        <img width ="400"src= "https://www.veldenzgymnasium.de/fileadmin/_processed_/d/e/csm_Weihnachtsgedicht_Luisa_Stemler__6a__5ac283a59c.jpg"/>
        ...
        <img width = "400" src="https://m.media-amazon.com/images/I/51TV1odXllL._AC_UF1000,1000_QL80_.jpg"/>

        <img width = "400" src="https://i.pinimg.com/236x/ee/a8/f0/eea8f04942445ce3e3b785db40ece6de.jpg"/>
        <img width = "400" src="wbaum.webp"/>

        <img width = "400" src="https://i.pinimg.com/736x/7e/fe/a4/7efea475ee42206ea5fc693bb1620aaf.jpg"/>

        <img width="400" src="hasefahrer.jpeg"/>

        <img width="400" src="dunkelhas.jpeg"/>

        <img width = "400" src="1hase.jpeg"/>

        <img width="400" src="2hasen.jpeg"/>

        <img width = "400" src="hasemitz.jpeg"/>

        <img width = "400" src="mausin.jpeg"/>

        <img width = "400" src="eulekike.jpeg"/>
        <img width = "400" src="katz.jpeg"/>
    ...
    <script>
        // Funktion, um den gesamten Text der Webseite vorzulesen
        function vorlesen() {
            // Gesamten Text der Webseite erfassen
            const text = document.body.innerText;

            // Prüfen, ob SpeechSynthesis unterstützt wird
            if ('speechSynthesis' in window) {
                // Neue Sprachsyntheseinstanz erstellen
                const utterance = new SpeechSynthesisUtterance(text);

                // Stimme anpassen (optional)
                utterance.lang = 'de-DE'; // Sprache auf Deutsch setzen
                utterance.pitch = 1; // Tonhöhe
                utterance.rate = 1; // Lesegeschwindigkeit

                // Text vorlesen
                window.speechSynthesis.speak(utterance);
            } else {
                alert('Speech Synthesis wird von diesem Browser nicht unterstützt.');
            }
        }

        // Event-Listener für einen Button (optional)
        document.getElementById('readTextButton').addEventListener('click', vorlesen);
